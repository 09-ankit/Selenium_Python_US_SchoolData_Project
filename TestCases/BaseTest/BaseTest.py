...
I am Akshay Bhattad, and I come with a strong background in Software Development with 3 years of experience
My Skills Includes - Java ,Spring Boot,Hibernate, Spring Jpa, Rest API, Postman , SQL , Git
Programming Language - Java ,Spring Boot ,Groovy
...
SearchTexts=["java developer 3 years remote * ", "java developer 3 years Nagpur *" , "java developer 3 years *"]
j=0
while(j<=2):
...
def send_Email():
    ...
    driver.find_element(By.XPATH, "(//input[@placeholder='Subject'])").send_keys("Resume for Java Developer Profile")
